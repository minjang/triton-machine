...
class CPUOptions:
    ...
    # Note that we will explore a way of multiple warps in the future.
    warp_size: int = 1
    num_warps: int = 1
    num_ctas: int = 1
...
class CPUBackend(BaseBackend):
    ...
    def make_llir(src, metadata, options):
        ...
        cpu.passes.ttmir.add_to_llvmir(pm)
